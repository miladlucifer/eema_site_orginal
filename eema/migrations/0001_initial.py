    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('short_body', ckeditor.fields.RichTextField(blank=True)),
                ('status', models.CharField(choices=[('P', 'Published'), ('N', 'Not Published'), ('D', 'Draft'), ('R', 'Pending Review')], default='N', max_length=1)),
                ('image', models.ImageField(default='default.jpg', upload_to='blog/blogpost_cover')),
                ...
                ('category', models.ManyToManyField(blank=True, related_name='blog_posts', to='eema.category')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='orders', to='eema.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='eema.product')),
            ],
        ),
        migrations.AddField(
            model_name='category',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='eema.order')),
